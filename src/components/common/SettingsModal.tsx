              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 space-y-3">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 dark:text-neutral-400">
                      Set your default sign-in option for standard application launch.
                    </p>
                  </div>

                  <div className="grid grid-cols-3 gap-2.5 pt-1">
                    {(['email', 'google', 'guest'] as PreferredLoginMethod[]).map((method) => {
                      const isSelected = settings.preferredLoginMethod === method;
                      return (
                        <button
                          key={method}
                          onClick={() => updateSettings({ preferredLoginMethod: method })}
                          className={`p-3 rounded-2xl border text-xs font-bold flex flex-col items-center gap-2 transition-all ${
                            isSelected
                              ...
                              : 'bg-white dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-700 dark:text-neutral-300 hover:border-slate-400 dark:hover:border-white/30'
                          }`}
                        >
                          ...
                          {method === 'guest' && <UserCheck className="w-5 h-5" />}
                          <span className="capitalize">{method === 'email' ? 'Email Auth' : method}</span>
                        </button>
                      );
                    })}
                  </div>
                ...
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 space-y-3">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 dark:text-neutral-400">
                      Sign in or connect using your preferred service.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <button
                      ...
                      className="px-4 py-2.5 rounded-2xl bg-white dark:bg-white/10 border border-slate-200 dark:border-white/15 text-slate-900 dark:text-white font-bold text-xs flex items-center justify-center gap-2 hover:bg-slate-100 dark:hover:bg-white/20 transition-all"
                    >
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 rounded-2xl bg-white dark:bg-white/10 border border-slate-200 dark:border-white/15 text-slate-900 dark:text-white font-bold text-xs flex items-center justify-center gap-2 hover:bg-slate-100 dark:hover:bg-white/20 transition-all disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 rounded-2xl bg-white dark:bg-white/10 border border-slate-200 dark:border-white/15 text-slate-900 dark:text-white font-bold text-xs flex items-center justify-center gap-2 hover:bg-slate-100 dark:hover:bg-white/20 transition-all disabled:opacity-50"
                    >
                      <UserCheck className="w-4 h-4" /> Guest Mode
                    </button>
                  </div>
                </div>
