        ...
        {isConnected ? (
          ...
          <div className="space-y-5">
            ...
            <div className="relative flex items-center justify-center my-4">
              ...
              <span className="bg-white dark:bg-[rgba(18,18,18,1)] px-3 text-[10px] font-bold text-slate-400 dark:text-neutral-500 uppercase tracking-wider shrink-0">
                Or sign in with
              </span>
              <div className="border-t border-slate-200 dark:border-white/10 w-full" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                disabled={loading}
                className="w-full py-2.5 px-3 rounded-2xl bg-slate-100 dark:bg-white/10 hover:bg-slate-200 dark:hover:bg-white/20 text-slate-900 dark:text-white text-xs font-bold flex items-center justify-center gap-2 transition-all border border-slate-200 dark:border-white/10 disabled:opacity-50"
              >
