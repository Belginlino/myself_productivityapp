...
const firebaseConfig = {
  ...
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || "myself-productivity-os",
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || "myself-productivity-os.appspot.com",
